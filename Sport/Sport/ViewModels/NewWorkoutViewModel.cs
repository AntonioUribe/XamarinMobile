...
namespace Sport.ViewModels
{
    public class NewWorkoutViewModel : BaseViewModel
    {
        ...
        private string _textDifficulty = "Facíl";
        ...
        {
            var result = await App.Current.MainPage.DisplayActionSheet("Dificultad", "Cancelar", null, "Facíl", "Medio", "Dificil");
            ...
            try
            {
                ...
                StackLayout stackLayout = new StackLayout
                {
                    ...
                    Children =
                    {
                        ...
                        new Button { Text = "Eliminar", CornerRadius= 10, HorizontalOptions = LayoutOptions.EndAndExpand, 

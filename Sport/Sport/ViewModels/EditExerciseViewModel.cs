...
namespace Sport.ViewModels
{
    ...
    public class EditExerciseViewModel : BaseViewModel
    {
        ...
        private string textDifficulty = "Facíl";
        ...
        public async void LoadItemId(int exerciseId)
        {
            ...
            {
                Debug.WriteLine("Error al cargar");
            }
        }
        ...
        {
            var result = await App.Current.MainPage.DisplayActionSheet("Dificultad", "Cancelar", null, "Facíl", "Medio", "Díficil");
